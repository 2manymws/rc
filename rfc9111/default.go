...
var defaultUnderstoodMethods = []string{
	// Although not explicitly specified in RFC 9111, allow GET, HEAD, OPTIONS, and TRACE methods, which are specified as safe methods in RFC 9110 (see https://www.rfc-editor.org/rfc/rfc9110#section-9.2.1).
	http.MethodGet,
	http.MethodHead,
	http.MethodOptions,
	http.MethodTrace,
